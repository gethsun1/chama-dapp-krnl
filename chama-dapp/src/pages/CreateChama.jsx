...
const CreateChama = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Get KRNL validation payload for creating a Chama
      console.log("[KRNL] Requesting validation for creating Chama");
      ...
      const contract = new Contract(UPGRADED_CHAMA_FACTORY_ADDRESS, UPGRADED_CHAMA_FACTORY_ABI, signer);
